...
from src.utils.config import BASE_DIR, DATASET_DIR, TRAINER_DIR, ATTENDANCE_DIR, ATTENDANCE_FILE, LABELS_FILE, CASCADE_PATH, ensure_project_dirs
...
__all__ = [
    # config
    "BASE_DIR", "DATASET_DIR", "TRAINER_DIR", "ATTENDANCE_DIR", "ATTENDANCE_FILE", "LABELS_FILE", "CASCADE_PATH", "ensure_project_dirs",
    # camera
